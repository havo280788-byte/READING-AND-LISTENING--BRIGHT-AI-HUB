      ...
      <div className="mt-auto hidden md:flex flex-col pt-8 border-t border-[#2ECC71]/10">
        <div className="bg-green-50 p-4 rounded-3xl mb-4 border border-[#2ECC71]/10">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button onClick={onLogout} className="py-2.5 bg-white border border-[#27AE60]/20 rounded-2xl text-[10px] font-black text-[#5D6D61] hover:bg-green-50 transition-all">EXIT</button>
            <button onClick={onReset} className="py-2.5 bg-white border border-[#27AE60]/20 rounded-2xl text-[10px] font-black text-[#27AE60] hover:bg-green-50 transition-all">RESET</button>
          </div>
        </div>
      </div>
    </nav>
